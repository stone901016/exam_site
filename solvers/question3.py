...
def solve(_):
    ...
    2) 假設 P_mean=50 固定，P_SD 分別為 8、10、12 → 繪製 P(Profit>100) 機率變化圖，並說明
    """
    # ── 參數設定 ──
    S, V = 10.0, 0.6
    SD_const = 10.0
    ...
    explain1 = (
        ...
        f"由於 SD 固定為 {SD_const}，Profit 的標準差均為 {sensitivity[mean_values[0]]:.1f}。"
    )

    # ── 第二部分：P_mean=50 固定，SD=8,10,12 ──
    P_mean_fixed = 50.0
    prob_gt100 = {}
    for sd in [8, 10, 12]:
